package com.example.converters.viewmodel

import androidx.compose.runtime.mutableStateOf
import androidx.lifecycle.ViewModel
import com.example.converters.model.RecentResult
import com.example.converters.utils.ConverterUtil
import com.example.converters.utils.ConverterUtil.CONVERTER_TYPES
...
class ConverterScreenViewModel: ViewModel() {
    ...
    fun getConverterValues(converterType: String): List<String>{
